...
if __name__ == "__main__":
    ...
    infer_openai_model_prompts(model=model, mode="time", rd=1, output_path="prompt_chat_results", inputs_file=f"prompt_chat_results/gpt-4/time/rd0.json", sample_num=20, batch_split=True, checked_inputs_file="prompt_chat_results/gpt-4/time/rd0_CHECKED.json", history_file="prompt_chat_results/gpt-4/time/rd1_HISTORY.json")
